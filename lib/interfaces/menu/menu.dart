        ...
        child: Column(
          ...
          children: [
            ...
            boxOptionMenu(
              context: context,
              onPressedButton: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const StockPresenter()));
              },
            ...
            boxOptionMenu(
              context: context,
              onPressedButton: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const RegisterUserPresenter()));
              },
